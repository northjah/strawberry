...
public class MainFrame extends BrowserFrame {
    ...
    public MainFrame(boolean osrEnabled, boolean transparentPaintingEnabled,
        ...
        if (CefApp.getState() != CefApp.CefAppState.INITIALIZED) {
            ...
            String path = "D:/win64/bin/lib/win64";


            settings.resources_dir_path = path;

            settings.locales_dir_path = path + "/locales";
            settings.browser_subprocess_path = path + "/jcef_helper.exe";


            settings.cache_path = "D:/win64/bin/lib/win64/cache";
